        ...
        <div className="w-full max-w-2xl">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-zinc-900 text-white rounded-lg hover:bg-zinc-800 transition-colors font-medium"
            >
              <KeyRound size={20} />
            ...
            {postsLoading ? (
              ...
              <div className="text-center py-8">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-zinc-900 hover:bg-zinc-800 text-white font-semibold rounded-lg transition-colors"
                >
